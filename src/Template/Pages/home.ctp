<?php
//echo SITE_URL; exit('SITE_URL');

?>
<!--<div id="iview" class="main-slider">
    <div data-iview:thumbnail="http://172.10.1.3:8037/img/img_health_ins.jpg" data-iview:image="http://172.10.1.3:8037/img/media/slider_main/1.jpg" data-iview:transition="block-drop-random" >
      <div class="container">
        <div class="iview-caption bg-no-caption" data-x="660" data-y="143" data-transition="expandLeft">
          <div class="custom-caption">
            <p class="slide-title bg-color_second">Be a Requestor</p>
            <p class="slide-title_second">Sed posuere nunc libero pellentesque vitae</p>
            <p class="slide-text">Sed posuere nunc libero pellentesque vitae</p>
            <?php echo $this->Html->link('REGISTER',['controller' => 'requestors', 'action' => 'requestorRegistration', '_full' => true],['class'=>'btn bg-color_primary','escape' => false]);?>
          </div>
        </div>
      </div>
    </div>
    <div data-iview:thumbnail="http://172.10.1.3:8037/img/media/slider_main/2.jpg" data-iview:image="http://172.10.1.3:8037/img/media/slider_main/2.jpg" data-iview:transition="block-drop-random" >
      <div class="container">
        <div class="iview-caption  bg-no-caption" data-x="260" data-y="293" data-transition="expandLeft">
          <div class="custom-caption">
            <p class="slide-title bg-color_second">Be a Provider</p>
            <p class="slide-title_second">Sed posuere nunc libero pellentesque vitae</p>
            <p class="slide-text">Sed posuere nunc libero pellentesque vitae</p>
            <?php echo $this->Html->link('REGISTER',['controller' => 'providers', 'action' => 'providerRegistration', '_full' => true],['class'=>'btn bg-color_primary','escape' => false]);?>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="carousel-inner">
   <div class="active item">
                     <img src="media/slider_main/4.jpg">
                     <div class="custom-caption ">
            <p class="slide-title bg-color_second">Be a Requestor</p>
            ...
            <?php echo $this->Html->link('REGISTER',['controller' => 'requestors', 'action' => 'requestorRegistration', '_full' => true],['class'=>'btn bg-color_primary','escape' => false]);?>
				     ...
				     <div class=" item">
                     <img src="media/slider_main/3.jpg">
                     <div class="custom-caption ">
            <p class="slide-title bg-color_second">Be a Provider</p>
            <p class="slide-title_second">To Take Care Of Your Health</p>
            <p class="slide-text">Sed posuere nunc libero pellentesque vitae</p>
...
<!--  <div class="container">
  ...
  <section class="advantages wow fadeInUp" data-wow-delay="1.5s" id="aboutUs_Id">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
...
<!--  <div class="banner mod-1 bg bg_3 bg_transparent wow zoomIn" data-wow-delay="1s">
  ...
  <div class="section-large bg bg_4" id="service_id">
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-md-offset-2 col-sm-6">
          <h2 class="ui-title-block ui-title-block_small">Requestor <span>services</span></h2>
          ...
          <ul class="list-mark list-mark_big">
            <li><a class="icon icon-login" href="javascript:void(0);">Pellentesque vitae ultrice posuere</a></li>
            <li><a class="icon icon-login" href="javascript:void(0);">Pellentesque vitae ultrice posuere</a></li>
            <li><a class="icon icon-login" href="javascript:void(0);">Pellentesque vitae ultrice posuere</a></li>
            <li><a class="icon icon-login" href="javascript:void(0);">Pellentesque vitae ultrice posuere</a></li>
            <li><a class="icon icon-login" href="javascript:void(0);">Pellentesque vitae ultrice posuere</a></li>
        ...
        <div class="col-md-4 col-md-offset-2 col-sm-6">
          <h2 class="ui-title-block ui-title-block_small">Provider <span>services</span></h2>
          <!--<p class="ui-text">Pellentesque vitae ultrice posuere. Praesent justo laoret dignis lectus etiam ipsum habitant tristique nam est. Donec venentse eu varius cursus masa metus adipiscing ante.</p>-->
          <ul class="list-mark list-mark_big">
            <li><a class="icon icon-login" href="javascript:void(0);">Pellentesque vitae ultrice posuere</a></li>
            <li><a class="icon icon-login" href="javascript:void(0);">Pellentesque vitae ultrice posuere</a></li>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <article class="article-short wow bounceInUp" data-wow-delay=".5s">
            ...
            <img src="media/290x250/2.jpg" height="250" width="290" alt="Foto"> <a href="javascript:void(0);" class="category color_primary">Dental Surgery</a> <a href="javascript:void(0);" class="autor">By Dr. Smith</a>
        ...
        <div class="col-sm-4">
          <article class="article-short wow bounceInRight">
            ...
            <img src="media/290x250/3.jpg" height="250" width="290" alt="Foto"> <a href="javascript:void(0);" class="category color_primary">Eye Disease</a> <a href="javascript:void(0);" class="autor">By Dr. Smith</a>
