                  ...
                  <?php echo $this->Form->input('state',array('label' => false,'div' => false, 'value'=>isset($userData['state'])?$userData['state']:'' , 'class' => 'form-control', 'type'=>'text','maxlength'=>20));?>  
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                   <?php 
                   echo $this->Form->input('country',array('label' => false,'div' => false,'options'=>$countryList , 'class' => 'form-control', 'type'=>'select', 'empty'=>'please select country', 'value'=>isset($userData['country_id'])?$userData['country_id']:''));?>  
                                        </div></div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
