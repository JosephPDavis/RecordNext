                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8" style="margin-top:6px;">
                                                <?php echo $this->Html->link('<i class="fa fa-cloud-download" title="Sample CSV File"></i> ','img/hippa/Import_User_Sample_en.csv',['class'=>'downloadIcon','escape'=>false,'target' => '_blank']);?>             
