                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered  table-striped">
                            <tr>
                                ...
                                <th><?php echo $this->Paginator->sort('request_status', 'Status'); ?></th>
                                <th>Action  </th>
                            </tr>
                            <?php 
...
//                            $srno= 1;
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="link-span"> <?php echo $this->Html->link('View Request ',['controller' => 'Requestors', 'action' => 'viewRequest',$this->Common->encrypt($req['id']),'_full' => true],['class'=>'label label-warning','escape'=>false]);?></span>     
                                    <span class="link-span"><?php echo $this->Html->link('View HIPAA Authorization Form','img/hippa/original/'.$req['upload_hippa'],['class'=>'label label-info','escape'=>false,'target' => '_blank']);?>    </span>         
                                </td>
                            </tr>
                            <?php 
//                            $srno++;
