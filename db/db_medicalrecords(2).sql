...
--
-- Host: localhost
-- Generation Time: Dec 22, 2017 at 02:23 PM
...
CREATE TABLE `clients` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL COMMENT 'from users table, by whom this client has been added',
...
(254, 'United States', 'US', 'US', 'USA', '840', 'US', 'Washington, DC ', 'North America ', 'American', 'Americans', 'US Dollar', 'USD', 278058881, 'The United States', '', 1, 0, '2015-10-28 00:00:00', '2015-10-30 08:33:11'),
...
(284, 'test1', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, '2015-10-28 00:00:00', '2015-10-30 08:33:11');
...
CREATE TABLE `matters` (
  ...
  `threshold` float(5,2) DEFAULT NULL,
...
CREATE TABLE `payments` (
  ...
  `cost_of_request` float(5,2) DEFAULT NULL,
  `system_fee` float(5,2) DEFAULT NULL,
...
(242, 4, NULL, NULL, 53.20, 'cus_ByKhCgUU8hAUkB', NULL, 'n', 0, '2017-12-19 08:07:03', '2017-12-19 00:00:00', '2017-12-19 08:07:03', 3, NULL, 0),
...
CREATE TABLE `requests` (
  ...
  `matter_no` varchar(225) DEFAULT NULL,
  ...
  `client_name` varchar(255) DEFAULT NULL COMMENT 'client id from client table',
  ...
  `system_fee` int(11) DEFAULT NULL,
...
INSERT INTO `requests` (`id`, `request_id`, `matter_no`, `client_id`, `matter_id`, `description`, `first_name`, `last_name`, `dob`, `rec_start_date`, `rec_end_date`, `requestor_id`, `provider_id`, `client_name`, `department_id`, `request_status`, `pages`, `ProFees`, `feesType`, `finalFees`, `request_completion_file_path`, `date_of_request`, `estimated_delivery_date`, `requested_format`, `provider_acknowledgement`, `threshold`, `ssn_no`, `system_fee`, `total_cost`, `record_type`, `hippa_form_date`, `upload_hippa`, `payment_status`, `status`, `reason`, `is_deleted`, `created`, `modified`) VALUES
(1, '1', '', NULL, NULL, 'qwerty', 'Sneha', 'Gosewade', '2017-12-14', '2017-12-15', '2017-12-28', 1, 2, '', 0, 5, 0, '', 0, 0.00, 'a:1:{i:0;s:28:\"1513399953_MRR_db_schema.pdf\";}', '2017-12-15 14:59:41', NULL, NULL, NULL, '23.20', '798-62-3665', NULL, NULL, 1, '2017-12-15', '1513349962_model.pdf', 0, 1, NULL, 0, '2017-12-15 14:59:41', '2017-12-16 04:52:34'),
(2, '2', '12301', 1, 1, 'sadasdasd', 'Test', 'User', '1992-10-28', '2017-12-01', '2017-12-31', 1, 2, 'CL123', 1, 6, 0, '', 0, 0.00, NULL, '2017-12-15 15:07:55', NULL, NULL, NULL, '32.20', '789-41-3213', NULL, NULL, 1, '2017-12-27', '1513350448_model.pdf', 0, 1, 'Don\'t know', 0, '2017-12-15 15:07:55', '2017-12-16 04:51:25'),
(3, '3', '', NULL, NULL, 'test description', 'testing', 'testing', '2000-01-01', '2016-03-03', '2017-12-01', 3, 2, '', 1, 2, 5, '', 0, 50.00, NULL, '2017-12-18 12:47:56', NULL, NULL, NULL, '900', '', NULL, NULL, 3, '2017-12-20', '1513601250_sample.pdf', 0, 1, NULL, 0, '2017-12-18 12:47:56', '2017-12-19 06:33:14'),
(4, '4', '12301', 1, 1, 'qwerty', 'Test', 'User', '2017-12-07', '2017-12-13', '2017-12-26', 3, 2, 'CL123', 1, 0, NULL, '', 0, NULL, NULL, '2017-12-19 08:07:03', NULL, NULL, NULL, '53.2', '789-45-4654', NULL, NULL, 1, '2017-12-28', '1513670684_BMGPG5343F_Q1_2017-18.pdf', 0, 1, NULL, 0, '2017-12-19 08:07:03', '2017-12-19 08:07:03'),
(5, '5', '', NULL, NULL, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque sollicitudin arcu nec nulla eleifend tempor. Sed dapibus dui ante, id feugiat ligula tincidunt sed. Quisque varius, justo ut auctor feugiat, elit ipsum convallis purus, aliquet tristique elit nisi ac purus. Proin a elementum orci. Fusce a auctor velit. Aenean vel facilisis metus. Proin vitae nibh et leo scelerisque placerat. Sed ac est lacus. Maecenas venenatis dapibus vestibulum. Vivamus vel dignissim odio. Nullam faucibus, ligula in fermentum cursus, nisi velit fermentum lacus, id lacinia risus lacus id ante. Praesent pulvinar ut diam vitae interdum. In hac habitasse platea dictumst. Mauris iaculis lobortis lectus ut iaculis. Nullam tincidunt rutrum quam sit amet condimentum. Mauris leo nisi, interdum nec lectus a, molestie porttitor nulla. ', 'test', 'testtt', '1980-02-19', '2017-12-01', '2017-12-22', 3, 2, '', 1, 2, 6, '', 0, 60.00, NULL, '2017-12-19 08:45:30', NULL, NULL, NULL, '568', '456-45-6655', NULL, NULL, 1, '2017-12-20', '1513673045_pdf-sample.pdf', 0, 1, NULL, 0, '2017-12-19 08:45:30', '2017-12-19 09:07:04'),
(6, '6', '04545456', 2, 2, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque sollicitudin arcu nec nulla eleifend tempor. Sed dapibus dui ante, id feugiat ligula tincidunt sed. Quisque varius, justo ut auctor feugiat, elit ipsum convallis purus, aliquet tristique elit nisi ac purus. Proin a elementum orci. Fusce a auctor velit. Aenean vel facilisis metus. Proin vitae nibh et leo scelerisque placerat. Sed ac est lacus. Maecenas venenatis dapibus vestibulum. Vivamus vel dignissim odio. Nullam faucibus, ligula in fermentum cursus, nisi velit fermentum lacus, id lacinia risus lacus id ante. Praesent pulvinar ut diam vitae interdum. In hac habitasse platea dictumst. Mauris iaculis lobortis lectus ut iaculis. Nullam tincidunt rutrum quam sit amet condimentum. Mauris leo nisi, interdum nec lectus a, molestie porttitor nulla. ', 'testname', 'testsurname', '1970-11-25', '2017-12-08', '2017-12-22', 3, 2, 'testname', 1, 3, 5, '50', 1, NULL, 'a:1:{i:0;s:36:\"1513950032_BMGPG5343F_Q2_2017-18.pdf\";}', '2017-12-19 09:15:03', NULL, NULL, NULL, '565', '454-56-4564', 2, 52, 1, '2017-12-08', '1513674890_pdf-sample.pdf', 0, 1, NULL, 0, '2017-12-19 09:15:03', '2017-12-22 13:40:32'),
(7, '7', '12301', 1, 1, 'dterterterte', 'dsd', 'edsad', '2017-12-12', '2017-12-27', '2018-01-04', 74, 2, 'CL123', 1, 0, NULL, '', 0, NULL, NULL, '2017-12-20 06:37:39', NULL, NULL, NULL, '434', '343-43-434', NULL, NULL, 1, '2017-12-19', '1513751840_MRR_db_schema.pdf', 0, 1, NULL, 1, '2017-12-20 06:37:39', '2017-12-20 13:13:30'),
(8, '8', 'test', 3, 3, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque sollicitudin arcu nec nulla eleifend tempor. Sed dapibus dui ante, id feugiat ligula tincid', 'first name', 'last name', '2017-12-07', '2017-12-08', '2017-12-28', 3, 2, 'test', 0, 3, 0, '', 0, 450.00, NULL, '2017-12-20 09:34:11', NULL, NULL, NULL, '541', '454-56-5645', NULL, NULL, 1, '2017-12-22', '1513762344_pdf-sample.pdf', 0, 1, NULL, 0, '2017-12-20 09:34:11', '2017-12-20 12:01:38'),
(9, '9', '12301', 1, 1, 'qwerty', 'test', 'user', '2017-12-05', '2017-12-19', '2017-12-27', 3, 75, 'CL123', 0, 0, NULL, '', 0, NULL, NULL, '2017-12-20 13:09:28', NULL, NULL, NULL, '53.2', '453-45-3453', NULL, NULL, 1, '2017-12-21', '1513775264_MRR_db_schema.pdf', 0, 1, NULL, 0, '2017-12-20 13:09:28', '2017-12-20 13:09:28'),
(10, '10', '', NULL, NULL, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque sollicitudin arcu nec nulla eleifend tempor. Sed dapibus dui ante, id feugiat ligula tincidunt sed. Quisque varius, justo ut auctor feugiat, elit ipsum convallis purus, aliquet tristique elit nisi ac purus. Proin a elementum orci. ', 'testname', 'testname', '1970-07-29', '2017-12-01', '2017-12-22', 3, 2, '', 1, 7, 0, '650', 0, 7.00, 'a:1:{i:0;s:18:\"1513942596_pdf.pdf\";}', '2017-12-21 06:24:41', NULL, NULL, NULL, '53.2', '465-45-4564', 32, 682, 3, '2017-12-14', '1513835323_sample.pdf', 0, 1, '', 0, '2017-12-21 06:24:41', '2017-12-22 14:02:07'),
(11, '11', '12365', 3, 5, ' Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque sollicitudin arcu nec nulla eleifend tempor. Sed dapibus dui ante, id feugiat ligula tincidunt sed. Quisque varius, justo ut auctor feugiat, elit ipsum convallis purus, aliquet tristique elit nisi ac purus.', 'testfirstname', 'testlastname', '1980-06-18', '2017-12-15', '2017-12-28', 3, 2, 'testclientname', 1, 3, 650, '6500', 1, NULL, 'a:1:{i:0;s:18:\"1513946250_pdf.pdf\";}', '2017-12-22 11:57:17', NULL, NULL, NULL, '600', '455-45-5464', 325, 6825, 1, '2017-12-20', '1513943593_pdf-sample.pdf', 0, 1, NULL, 0, '2017-12-22 11:57:17', '2017-12-22 12:37:30'),
(12, '12', '12301', 4, 6, '34534534534', 'Sneha', 'Gosewade', '2017-12-12', '2017-12-19', '2017-12-28', 74, 6, 'CL123', 0, 6, 0, 'NaN', 0, NULL, 'a:1:{i:0;s:36:\"1513951848_BMGPG5343F_Q1_2017-18.pdf\";}', '2017-12-22 13:46:54', NULL, NULL, NULL, '45.25', '534-53-4534', 5, 57, 1, '2017-12-27', '1513950392_BMGPG5343F_Q1_2017-18.pdf', 1, 1, NULL, 0, '2017-12-22 13:46:54', '2017-12-22 14:10:56');
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `password`, `phone`, `city`, `state`, `country`, `type`, `zip_code`, `street_address`, `company_name`, `department`, `about_company`, `key_token`, `reset_password_flag`, `description`, `threshold`, `using_our_system`, `card_preference_id`, `role_id`, `status`, `is_client_matter_preference`, `is_deleted`, `created`, `modified`) VALUES
...
(2, 'Demo', 'Provider', 'demo_pro@mailinator.com', '$2y$10$kFfA8BGNNN6t5boqMcSoOuauQhSLitT3gtb4TelB6p30MCLYB4IBS', '9632587412', 'Panchgani', 'MH', '112', 2, '440002', 'Bugget Valley', 'Snehag Co', '1', 'Test Co', 'f349fca084bca9919ce53481aaa4a600', 0, 'testing', NULL, NULL, NULL, 2, 1, 1, 0, '2017-12-15 14:55:52', '2017-12-18 11:40:17'),
(3, 'Demo', 'Requestor', 'demo_req@mailinator.com', '$2y$10$L9BOMiPvlxFqYwfWL/UbWeElRDJfeZm3Bpo.p7uEvg4ZCOgNl/ZJe', '78785255232', 'Nagpur', 'Mh', '112', 2, '440002', 'ten downing street', 'SG Co', NULL, 'This is dummy company', '483c79a06d2f6e3baf15d7e0188a1fd4', 0, 'bgdsgdgdfg', 53.20, NULL, 11, 3, 1, 1, 0, '2017-12-15 14:52:21', '2017-12-21 10:15:16'),
...
(6, 'sneha1', 'Provider1', 'sneha_pro@yopmail.com', '$2y$10$RlCDEk23AUad.648L5NaEeO4s2Xzw4nahHvUPn66kjBukczG83p4i', '78965412221', 'city1', 'state1', '48', 1, '65654554651', 'strret Address1', 'compnt1', NULL, 'edsadsad1', NULL, 0, NULL, NULL, NULL, NULL, 2, 1, 1, 0, '2017-12-18 08:38:16', '2017-12-20 14:59:30'),
(7, 'test', 'test', 'test1@yopmail.com', '$2y$10$L7RSkWGVd0MOLEhZBN5ZcOlUyjfdf/GNa9jA1PPsVT8Eldwm2Hppy', '5345345435', 'fdf', 'fds', '11', 1, '5345', 'fsdf', 'tret', NULL, 'fsdggfdgdfg', NULL, 0, NULL, NULL, NULL, NULL, 3, 1, 1, 0, '2017-12-18 11:02:46', '2017-12-20 14:59:42'),
(8, 'firstggg', 'last', 'req_sneha1@yopmail.com', '$2y$10$u2H6yRLPJaawvP2tyispWurkRbFdJae.IPSoIgJLC0DSH5z41FXK6', '5345345345', 'fsdf', 'sdf', '4', 1, '435345345', 'vdsfdsfsdf', 'compnt', NULL, 'fsfsdfsdfsd', NULL, 0, NULL, NULL, NULL, NULL, 3, 1, 1, 0, '2017-12-18 12:18:50', '2017-12-20 08:56:45'),
(74, 'Sneha', 'Requestor', 'sneha_req@yopmail.com', '$2y$10$wYlQiF08cCgdfbosKAIV5.P3X8D.kWWarVSwjFiUIZc.rxxseH9eG', '789654133', 'Nagpur', 'Maharashtra', '0', 2, '4400022', 'Ten downing street', 'qwerty', NULL, 'qwewqe', '7ca8d414f27caa09bd864d360c75f5e4', 0, 'testinh', NULL, NULL, 12, 3, 1, 1, 0, '2017-12-20 06:26:16', '2017-12-22 13:47:14'),
(75, 'testProvider', 'testProvider', 'demo_pro2@yopmail.com', '$2y$10$vVhG.u85KMuSB8pvWfDZIe34ntDIrZGHl3qEM5wV54R6HNU/PdIE.', '123121212313212', 'ngp', 'mh', '0', 2, '440026', 'test street address only dummy', NULL, NULL, NULL, '20f463b348e2b35e5ed98c6fab9b5114', 0, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque sollicitudin arcu nec nulla eleifend tempor. Sed dapibus dui ante, id feugiat ligula tincidunt sed.', NULL, NULL, NULL, 2, 1, 1, 0, '2017-12-20 12:53:05', '2017-12-21 04:30:55');
...
--
ALTER TABLE `countries`
  MODIFY `id` bigint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=285;
--
...
--
ALTER TABLE `users`
  MODIFY `id` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;COMMIT;
